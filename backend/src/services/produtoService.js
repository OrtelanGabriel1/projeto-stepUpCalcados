...
class ProdutoService {
  ...
  async criarProduto(dados) {
    let { nome, descricao, preco_venda, preco_custo, tamanho, cor, genero } =
      dados;
    ...
    if (
      ...
      throw {
        status: 400,
        mensagem:
          "Nome, cor, preço de venda, preço de custo e tamanho são obrigatórios",
      };
    }
    ...
    if (isNaN(preco_venda) || isNaN(preco_custo) || isNaN(tamanho)) {
      throw {
        status: 400,
        mensagem: "Preço de venda, preço de custo e tamanho devem ser números",
      };
    }
